...
function exportSelectedToExcel($selectedIds, $connection)
{
    ...
    header("Content-Disposition: attachment; filename=\"AdminFinancial_data.xls\"");
...
<head>
    ...
    <title>Admin Financial Beneficiaries</title>
    <!-- CSS FILES -->
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <table class="table table-hover">
                ...
                <a class='btn btn-primary btn-sm' href='../action_modal/editfinancial.php?id=$row[id]'><i class='fa-solid fa-pen-to-square fa-xl' style='color: #ffffff;''></i></a>

 
                <a class='btn btn-danger btn-sm' href='../action_modal/deletefinancial.php?id=$row[id]' onclick='return confirmDelete();'><i class='fa-solid fa-trash fa-xl' style='color: #ffffff;'></i></a>
...
function terminateData($connection)
{
    ...
    $sql = "DELETE FROM financial WHERE datecreated < '$expiryDate'";
