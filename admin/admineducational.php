...
function exportSelectedToExcel($selectedIds, $connection)
{
    ...
    header("Content-Disposition: attachment; filename=\"AdminEducational_data.xls\"");
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td> 
                                <a class='btn btn-primary btn-sm' href='../action_modal/editeducational.php?id=$row[id]'><i class='fa-solid fa-pen-to-square fa-xl' style='color: #ffffff;'></i></a>
                                <a class='btn btn-danger btn-sm' href='../action_modal/deleteeducational.php?id=$row[id]' onclick='return confirmDelete();'><i class='fa-solid fa-trash fa-xl' style='color: #ffffff;'></i></a>
                            </td>
                        </tr>
                        ";
                    }
...
function terminateData($connection)
{
    ...
    $sql = "DELETE FROM educational WHERE datecreated < '$expiryDate'";
