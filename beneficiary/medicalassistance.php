...
$query = "SELECT service_status FROM services WHERE service_name = 'medical_assistance'";
...
<body>
    <section class="container">
        <header>Medical Request Form</header><br>
        ...
        <form action="medicalassistance.php" class="form" method="post">
            <div class="input-box">
            ...
            <div class="input-box">
                ...
                <input type="text" value="Medical Assistance" name="medical" placeholder="Medical Assistance" readonly />
            </div>
            <div class="column">
                <div class="input-box">
            ...
            <div class="input-box">
                <label>Amount</label>
                <input type="number" name="amount" value="2000" placeholder="2000" readonly />
            </div>
            
            <div class="input-box">
                <input type="hidden" name="mstatus" value="pending">
            </div>
...
if (isset($_POST['submit'])) {
    ...
    $duplicateCheckQuery = $con->prepare("SELECT * FROM medical WHERE pnum = ?");
...
?>
        <script>
            swal({
                title: "Failed!",
                text: "You Already Sent A Medical Assistance",
                icon: "warning",
            });
        </script>

        <?php
    } elseif (!empty($fname) && !empty($lname) && !empty($bfname) && !empty($blname) && !is_numeric($fname) && !is_numeric($mname) && !is_numeric($lname) && !is_numeric($bfname) && !is_numeric($bmname) && !is_numeric($blname)) {

        //save to database

        $query = "insert into medical (fname,mname,lname,address,barangay,medical,age,bday,pnum,civil,gender,bfname,bmname,blname,baddress,bage,bbday,bcivil,bgender,brelation,mstatus,amount,datecreated) values ('$fname','$mname','$lname','$address', '$barangay','$medical','$age','$bday','$pnum','$civil','$gender','$bfname','$bmname','$blname','$baddress','$bage','$bbday','$bcivil','$bgender','$brelation','$mstatus','$amount', NOW())";
