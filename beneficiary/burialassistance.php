...
$query = "SELECT service_status FROM services WHERE service_name = 'burial_assistance'";
...
<body>
    <section class="container">
        <header>Burial Request Form</header><br>
        ...
        <form action="burialassistance.php" class="form" method="post">
            <div class="input-box">
            ...
            <div class="input-box">
                ...
                <input type="text" value="Burial Assistance" name="burial" placeholder="Burial Assistance" readonly />
            </div>
            <div class="column">
                <div class="input-box">
            ...
            <div class="input-box">
                <label>Amount</label>
                <input type="number" name="amount" value="5000" placeholder="5000" readonly />
            </div>
            <div class="input-box">
                <input type="hidden" name="bstatus" value="pending">
            </div>
...
if (isset($_POST['submit'])) {
    ...
    $duplicateCheckQuery = $con->prepare("SELECT * FROM burial WHERE pnumber = ?");
...
?>
        <script>
            swal({
                title: "Failed!",
                text: "You Already Sent A Burial Assistance",
                icon: "warning",
            });
        </script>
        ...
        $query = "insert into burial (fname,mname,lname,address,barangay,burial,age,bday,pnumber,civil,gender,bfname,bmname,blname,baddress,bage,bbday,bcivil,bgender,brelation,bstatus,amount,datecreated) values ('$fname','$mname','$lname','$address', '$barangay','$burial','$age','$bday','$pnumber','$civil','$gender','$bfname','$bmname','$blname','$baddress','$bage','$bbday','$bcivil','$bgender','$brelation','$bstatus','$amount', NOW())";
