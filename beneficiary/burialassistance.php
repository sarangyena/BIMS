...
if (isset($_POST['submit'])) {
    ...
    $duplicateCheckQuery = $con->prepare("SELECT * FROM burial WHERE pnum = ?");
...
?>
        ...
        $query = "insert into burial (fname,mname,lname,address,barangay,burial,age,bday,pnum,civil,gender,bfname,bmname,blname,baddress,bage,bbday,bcivil,bgender,brelation,bstatus,amount,datecreated) values ('$fname','$mname','$lname','$address', '$barangay','$burial','$age','$bday','$pnum','$civil','$gender','$bfname','$bmname','$blname','$baddress','$bage','$bbday','$bcivil','$bgender','$brelation','$bstatus','$amount', NOW())";
