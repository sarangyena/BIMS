...
<nav class="navbar navbar-expand-lg bg-light shadow-lg">
    <div class="container">
        <a class="navbar-brand" href="../BIMS/home.php">
            <img src="images/districtlogo.png" class="logo img-fluid" alt="">
        </a>
...
<section class="section-padding">
    <div class="container">
        <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    <div class="featured-block d-flex justify-content-center align-items-center">
                        <a href="beneficiary/financialassistance.php" class="d-block">
                            <img src="images/icons/financial.png" class="featured-block-image img-fluid" alt="">
            ...
            <?php endif; ?>
            <?php if ($services['tesda_scholarship']): ?>
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                    <div class="featured-block d-flex justify-content-center align-items-center">
                        <a href="beneficiary/tesda.php" class="d-block">
                            <img src="images/icons/tesda.png" class="featured-block-image img-fluid" alt="">
                            <p class="featured-block-text"><strong>TESDA</strong> Scholarship</p>
                        </a>
                    </div>
                </div>
            <?php endif; ?>

            <?php if ($services['kda_bkda']): ?>
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    <div class="featured-block d-flex justify-content-center align-items-center">
                        <a href="beneficiary/medicalmission.php" class="d-block">
                            <img src="images/icons/medicalmission.png" class="featured-block-image img-fluid" alt="">
                            <p class="featured-block-text"><strong>Medical </strong> Mission</p>
                        </a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($services['kda_bkda']): ?>
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    <div class="featured-block d-flex justify-content-center align-items-center">
                        <a href="beneficiary/kda-bkda.php" class="d-block">
                            <img src="images/icons/cda.png" class="featured-block-image img-fluid" alt="">
                            <p class="featured-block-text"><strong>KDA /</strong> BKDA</p>
                        </a>
                    </div>
                </div>
            <?php endif; ?>
