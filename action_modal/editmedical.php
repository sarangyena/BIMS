...
$connection = new mysqli($servername, $username, $password, $database);
    ...
    $duplicateCheckQuery = $connection->prepare("SELECT * FROM medical WHERE pnum = ?");
...
<html lang="en">
  ...
  <body>
    <section class="container">
      <header>Medical Form</header>
      <form action="editmedical.php" class="form"  method="post">
        ...
        <div class="input-box">
          ...
          <input type="text" value="Medical" name="medical" placeholder="Medical" readonly />
        </div>
        ...
        <button type="button" class="cancel-button" onclick="location.href='../admin/adminmedical.php'">Cancel</button>
      </form>
    </section>
  </body>
</html>