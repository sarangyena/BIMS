...
$connection = new mysqli($servername, $username, $password, $database);
    ...
    if ( $_SERVER ['REQUEST_METHOD'] == 'GET' ) 
    {
      ...
      $sql = "SELECT * FROM burial WHERE id=$id";
    ...
    $duplicateCheckQuery = $connection->prepare("SELECT * FROM burial WHERE pnum = ?");
...
<html lang="en">
  ...
  <body>
    <section class="container">
      <header>Burial Form</header>
      <form action="editburial.php" class="form"  method="post">
        ...
        <div class="input-box">
          ...
          <input type="text" value="Burial" name="burial" placeholder="Burial" readonly />
        </div>
        ...
        <button type="button" class="cancel-button" onclick="location.href='../admin/adminburial.php'">Cancel</button>
      </form>
    </section>
  </body>
</html>